        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-8 relative z-10">
          <div className="text-center md:text-left">
            <div className="inline-flex items-center gap-2 px-3 py-1 bg-emerald-500/10 rounded-full mb-4 border border-emerald-500/20">
              ...
              <span className="text-emerald-400 text-[10px] font-black uppercase tracking-[0.2em]">Profile Configuration</span>
            </div>
            <h1 className="text-white text-3xl md:text-5xl font-black tracking-tighter leading-tight mb-3">
              Settings & Privacy
            </h1>
            <p className="text-slate-400 text-sm md:text-base font-medium">Manage your digital identity and security protocols.</p>
          </div>
