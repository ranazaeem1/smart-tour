...
import { createBooking, fetchTourById } from "@/lib/db";
          ...
          <section className="bg-white border border-slate-200 rounded-3xl p-5 md:p-6 shadow-sm xl:sticky xl:top-28">
            ...
            <div className="space-y-5">
              <div className="space-y-2">
                ...
                <input className="input !rounded-2xl !bg-white font-black" type="date" min={new Date().toISOString().split("T")[0]} value={bookingDate} onChange={event => setBookingDate(event.target.value)} />
              </div>
              <div className="space-y-2">
