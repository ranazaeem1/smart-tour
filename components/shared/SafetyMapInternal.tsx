...
export default function SafetyMapInternal({
  ...
  if (loading) {
    return (
      <div className="card h-[520px] sm:h-[650px] flex flex-col items-center justify-center bg-slate-900 border-none">
  ...
  return (
    <div className="card-premium p-0 overflow-hidden flex flex-col lg:flex-row h-[760px] sm:h-[820px] lg:h-[650px] border-none shadow-2xl relative bg-slate-900">
      <div className="w-full lg:w-[420px] h-[330px] sm:h-[360px] lg:h-full bg-slate-900/95 backdrop-blur-xl border-b lg:border-b-0 lg:border-r border-white/5 flex flex-col z-[1000]">
        <div className="p-5 sm:p-8 lg:p-10 border-b border-white/5 bg-slate-900/50">
          ...
          {zones.length === 0 ? (
            ...
            zones.map((zone) => (
              <div
                ...
                className={`p-4 sm:p-6 rounded-[24px] cursor-pointer transition-all border ${
      ...
      <div className="min-h-0 flex-1 relative bg-slate-950">
        <MapContainer
        ...
        <div className="absolute bottom-4 right-4 sm:bottom-8 sm:right-8 glass-dark p-4 sm:p-6 rounded-[20px] sm:rounded-[24px] z-[1000] space-y-3 min-w-[160px] sm:min-w-[200px]">
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-[2000] flex items-center justify-center p-4">
          ...
          <div className="card-premium max-w-[500px] w-full p-6 sm:p-10 lg:p-12 relative z-10 bg-slate-900 text-center">
            <button className="absolute top-4 right-4 sm:top-8 sm:right-8 text-slate-500" onClick={() => setIsModalOpen(false)}>
              <X size={20} />
            </button>
